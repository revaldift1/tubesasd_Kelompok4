...
class handLandmarkDetector():
    def __init__(self,image_mode=False,max_hands=2,modelComplexity=1,min_detection_confidence=0.8,min_tracking_confidence=0.5):
        ...
        self.hands = self.mpHands.Hands(self.image_mode,self.max_hands,modelComplexity,self.min_detection_confidence,self.min_tracking_confidence)
...
def main():
    ...
    while True:
        ...
        cv.rectangle(image,(10,10),(200,200),(0,255,0),-1)
        cv.putText(image,str(fingers_up),(30,190),cv.FONT_HERSHEY_SIMPLEX,5,(0,0,255),5)
